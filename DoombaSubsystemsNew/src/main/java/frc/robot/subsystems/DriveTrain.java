...
/** 
 * Drivetrain subsystem. Four-motor tank drive with CAN Spark Max controllers and encoders.
 */
public class DriveTrain extends Subsystem {
    ...
    public CANSparkMax backLeftController;
    private SpeedControllerGroup leftMotors;
    public CANSparkMax frontRightController;
    public CANSparkMax backRightController;
    ...
    public DriveTrain() {
        ...
        frontLeftController.setOpenLoopRampRate(0.5);
        ...
        frontRightController.setOpenLoopRampRate(0.5);
        ...
        frontLeftEncoder = new CANEncoder(frontLeftController);
        frontRightEncoder = new CANEncoder(frontRightController);
        backLeftEncoder = new CANEncoder(backLeftController);
        backRightEncoder = new CANEncoder(backRightController);
    }
    ...
    public void drive(double leftSpeed, double rightSpeed) {
        if(SmartDashboard.getBoolean("Overdrive Toggle", false)){
            differentialDrive1.tankDrive(-leftSpeed, -rightSpeed);
        } else differentialDrive1.tankDrive(leftSpeed * -0.7, rightSpeed * -0.7);
    }
}

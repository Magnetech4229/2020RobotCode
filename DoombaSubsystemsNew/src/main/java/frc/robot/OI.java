...
public JoystickButton pixyButton2;
...
launchButton8.toggleWhenPressed(new LauncherNegativeSpin());
...
launchButton5.toggleWhenPressed(new LauncherPositiveSpin());
...
//pixyButton2 = new JoystickButton(leftJoystick, 2);
//pixyButton2.whileHeld(new Pixy2Test());
